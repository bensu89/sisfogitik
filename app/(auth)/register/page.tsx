    ...
    return (
        <div className="h-full flex flex-col justify-center">
            ...
            <button
                ...
                className="w-full py-3 lg:py-4 flex items-center justify-center gap-3 bg-[#131314] hover:bg-[#202124] text-white rounded-xl transition-colors font-medium border border-[#303134] group"
            >
